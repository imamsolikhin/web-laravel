  ...
  <div class="{{ Metronic::printClasses('subheader-container', false) }} d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    <div class="d-flex align-items-baseline flex-wrap mr-5">
      ...
      <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
          <a href="{{ route('product.index','closing') }}" class="text-muted">Sales Return</a>
        </li>
        <li class="breadcrumb-item">
...
<div class="card card-custom">
  <div class="card-header bg-danger flex-wrap border-1 pt-1 pb-0 mb-2" style="min-height: 0;">
    <div class="card-title pt-1 pb-1">
      <h3 class="card-label font-weight-bolder text-white">Sales Return
        <div class="text-muted pt-2 font-size-lg">show Datatable from table Sales Return</div>
      </h3>
    </div>
...
<script type="text/javascript">
  ...
  var table = $('#datatable').dataTable({
    ...
    columns: [
      ...
      {title: "Sales Return  ", data: 'active_closing', defaultContent: '-', class: 'text-center dt-body-nowrap', autohide: false},
