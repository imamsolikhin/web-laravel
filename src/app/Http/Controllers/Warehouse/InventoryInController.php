...
class InventoryInController extends Controller {
    ...
    {
        static::$module = 'InventoryIn';
        static::$module_alias = 'InventoryIn';
        static::$auth = 'inventory-in';
        static::$path = route('warehouse.index','inventory-in');
        static::$data = route('warehouse.list','inventory-in');
        static::$delete = route('warehouse.delete',['inventory-in','']);
        static::$controller = getControllerName("Warehouse", "InventoryIn");
        static::$resource = getResourceName("Warehouse", "InventoryIn");
    ...
    public static function index() {
      ...
      return view('warehouse.inventory-in',$data);
    }
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Warehouse","InventoryIn",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
