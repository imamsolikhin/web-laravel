...
class DeliveryOrderController extends Controller {
    ...
    {
        static::$module = 'DeliveryOrder';
        static::$module_alias = 'DeliveryOrder';
        ...
        static::$controller = getControllerName("Warehouse", "DeliveryOrder");
        static::$resource = getResourceName("Warehouse", "DeliveryOrder");
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Warehouse","DeliveryOrder",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
