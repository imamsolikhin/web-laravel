...
class InventoryOutController extends Controller {
    ...
    {
        static::$module = 'InventoryOut';
        static::$module_alias = 'InventoryOut';
        static::$auth = 'inventory-out';
        static::$path = route('warehouse.index','inventory-out');
        static::$data = route('warehouse.list','inventory-out');
        static::$delete = route('warehouse.delete',['inventory-out','']);
        static::$controller = getControllerName("Warehouse", "InventoryOut");
        static::$resource = getResourceName("Warehouse", "InventoryOut");
    ...
    public static function index() {
      ...
      return view('warehouse.inventory-out',$data);
    }
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Warehouse","InventoryOut",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
