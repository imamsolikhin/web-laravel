...
class VisitPatientController extends Controller {
    ...
    public static function init()
    {
        ...
        static::$auth = 'visitpatient';
        static::$path = route('clinic.index','visitpatient');
        static::$data = route('clinic.list','visitpatient');
        static::$delete = route('clinic.delete',['visitpatient','']);
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Clinic","Kunjungan Pasien",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
