...
class PatientController extends Controller {
    ...
    {
        static::$module = 'Data Pasien';
        static::$module_alias = 'Data Pasien';
        static::$auth = 'patient';
        static::$path = route('clinic.index','patient');
        static::$data = route('clinic.list','patient');
        static::$delete = route('clinic.delete',['patient','']);
        static::$controller = getControllerName("Clinic", "Patient");
        static::$resource = getResourceName("Clinic", "Patient");
    ...
    public static function index() {
      ...
      return view('clinic.patient',$data);
    }
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Clinic","Data Pasien",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
