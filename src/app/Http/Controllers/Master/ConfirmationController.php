...
class ConfirmationController extends Controller {
    ...
    {
        static::$module = 'Confirmation';
        static::$module_alias = 'Confirmation';
        static::$auth = 'confirmation';
        static::$path = route('master.index','confirmation');
        static::$data = route('master.list','confirmation');
        static::$delete = route('master.delete',['confirmation','']);
        static::$controller = getControllerName("Master", "Confirmation");
        static::$resource = getResourceName("Master", "Confirmation");
