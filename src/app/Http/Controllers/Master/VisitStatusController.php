...
class VisitStatusController extends Controller {
    ...
    {
        static::$module = 'Visit Status';
        static::$module_alias = 'Visit Status';
        static::$auth = 'visit-status';
        static::$path = route('master.index','visit-status');
        static::$data = route('master.list','visit-status');
        static::$delete = route('master.delete',['visit-status','']);
        static::$controller = getControllerName("Master", "VisitStatus");
        static::$resource = getResourceName("Master", "VisitStatus");
    ...
    public static function index() {
      ...
      return view('master.visit-status',$data);
    }
