...
class ItemPriceController extends Controller {
    ...
    {
        static::$module = 'ItemPrice';
        static::$module_alias = 'ItemPrice';
        static::$auth = 'itemprice';
        static::$path = route('master.index','itemprice');
        static::$data = route('master.list','itemprice');
        static::$delete = route('master.delete',['itemprice','']);
        static::$controller = getControllerName("Master", "ItemPrice");
        static::$resource = getResourceName("Master", "ItemPrice");
    ...
    public static function index() {
      ...
      return view('master.item-price',$data);
    }
