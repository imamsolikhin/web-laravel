...
class ShiftWorkController extends Controller {
    ...
    {
        static::$module = 'Shift Work';
        static::$module_alias = 'Shift Work';
        static::$auth = 'shiftwork';
        static::$path = route('master.index','shiftwork');
        static::$data = route('master.list','shiftwork');
        static::$delete = route('master.delete',['shiftwork','']);
        static::$controller = getControllerName("Master", "ShiftWork");
        static::$resource = getResourceName("Master", "ShiftWork");
    ...
    public static function index() {
      ...
      return view('master.shift-work',$data);
    }
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Master","ShiftWork",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
