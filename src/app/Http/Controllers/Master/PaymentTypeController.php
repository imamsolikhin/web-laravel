...
class PaymentTypeController extends Controller {
    ...
    {
        static::$module = 'PaymentType';
        static::$module_alias = 'PaymentType';
        static::$auth = 'paymenttype';
        static::$path = route('master.index','paymenttype');
        static::$data = route('master.list','paymenttype');
        static::$delete = route('master.delete',['paymenttype','']);
        static::$controller = getControllerName("Master", "PaymentType");
        static::$resource = getResourceName("Master", "PaymentType");
    ...
    public static function index() {
      ...
      return view('master.payment-type',$data);
    }
