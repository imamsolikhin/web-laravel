...
class BankPaymentController extends Controller {
    ...
    {
        static::$module = 'Bank Payment';
        static::$module_alias = 'Bank Payment';
        static::$auth = 'bank-payment';
        static::$path = route('finance.index','bank-payment');
        static::$data = route('finance.list','bank-payment');
        static::$delete = route('finance.delete',['bank-payment','']);
        static::$controller = getControllerName("Finance", "Bank Payment");
        static::$resource = getResourceName("Finance", "Bank Payment");
    ...
    public static function index() {
      ...
      return view('finance.bank-payment',$data);
    }
