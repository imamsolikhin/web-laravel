...
-- ----------------------------
BEGIN;
INSERT INTO `sys_setup` VALUES ('SYS', 'localhost', 'HPI MANAGEMENT', 'HPI MANAGEMENT', 'images/stars.png', 'images/background/bg-network.jpg', 'images/background/stars.png');
COMMIT;
