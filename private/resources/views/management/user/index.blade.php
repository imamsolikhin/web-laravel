                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group">
                        <select class="form-control select2" id="access" data-placeholder="Choose One" name="access">
                            <option></option>
                            <option value="1" {{ old('access') == 1 ? 'selected' : '' }}>All Clients</option>
                            <option value="2" {{ old('access') == 2 ? 'selected' : '' }}>All Clients on Specific Property</option>
                            <option value="3" {{ old('access') == 3 ? 'selected' : '' }}>Specific Client</option>
                        </select>
                    </div>
                ...
                <div class="col-lg-4" id="div-client-property" hidden>
                    ...
                    <div class="input-group">
                        <select class="form-control select2" id="client_property_id" data-placeholder="Choose One" name="client_property_id">
                            ...
                            <option value="{{ $clientProperty->id }}" {{ old('client_property_id') == $clientProperty->id ? 'selected' : '' }}>{{ $clientProperty->name }}</option>
                            @endforeach
                        </select>
                    </div>
