  ...
  <div class="{{ Metronic::printClasses('subheader-container', false) }} d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    <div class="d-flex align-items-baseline flex-wrap mr-5">
      ...
      <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
          <a href="{{ route('master.city.index') }}" class="text-muted">Transaksi</a>
        </li>
        <li class="breadcrumb-item">
            ...
            <form class="form" id="form-input" action="{{ route('master.city.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-lg-6 container-fluid">
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Closing</label>
                                <div class="col-lg-8">
                                    <select class="form-control select2" name="param" style="width:100%;">
                                        <option>Email</option>
                    ...
                    <div class="col-lg-6 container-fluid">
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Status Closing</label>
                                <div class="col-lg-8">
                                    <select class="form-control select2" name="param"  style="width:100%;"></select>
                                </div>
                            </div>
                        </div>
                        <div class="mb-2">
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">No. Resi</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="Name" placeholder="Enter Name" value=""/>
                                </div>
                            </div>
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">No Ref</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="Name" placeholder="Enter Name" value=""/>
                                </div>
                            </div>
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <textarea type="text" class="form-control" name="Name" placeholder="Enter Name" value=""></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
