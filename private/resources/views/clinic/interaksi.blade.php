  ...
  <div class="{{ Metronic::printClasses('subheader-container', false) }} d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    <div class="d-flex align-items-baseline flex-wrap mr-5">
      ...
      <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
          <a href="{{ route('clinic.interaksi.index') }}" class="text-muted">Interaksi</a>
        </li>
        <li class="breadcrumb-item">
...
<div class="card card-custom">
  <div class="card-header bg-danger flex-wrap border-1 pt-1 pb-0 mb-2" style="min-height: 0;">
    <div class="card-title pt-1 pb-1">
      <h3 class="card-label font-weight-bolder text-white">Interaksi
        <div class="text-muted pt-2 font-size-lg">show Datatable from table Interaksi</div>
      </h3>
    </div>
...
<div class="modal fade" id="modal-form" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" id="form-input" action="{{ route('clinic.interaksi.store') }}" method="POST">
              {!! csrf_field() !!}
...
<script type="text/javascript">
  ...
  var table = $('#datatable').dataTable({
    ...
    ajax: {
      method: 'POST',
      url : '{{ route('clinic.interaksi.data') }}',
    ...
    columns: [
      ...
      {title: "Interaksi", data: 'InteractionCode', defaultContent: '-', class: 'text-center dt-body-nowrap', autohide: true},
  ...
  function show_data(id = "") {
      if (id !== "") {
          $.ajax({
              url: "{{ route('clinic.interaksi.store')}}/" + id,
              type: "GET",
              headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
              },
              success: function (response) {
                  $("#form-input").attr("action", "{{ route('clinic.interaksi.update','')}}/"+id);
                  ...
                  // document.getElementById('Consultation').value = response.data.Consultation;
          ...
          $("#form-input").attr("action", "{{ route('clinic.interaksi.store')}}");
          $('#form-input').trigger("reset");
          $('#method').val("POST");
