...
class CreateSlsClinicInteraksiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sls_clinic_interaksi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sls_clinic_interaksi');
    }
}
