...
class CreateSlsProductFollowupTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sls_product_followup', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sls_product_followup');
    }
}
