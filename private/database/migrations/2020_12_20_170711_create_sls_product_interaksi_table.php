...
class CreateSlsProductInteraksiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sls_product_interaksi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sls_product_interaksi');
    }
}
