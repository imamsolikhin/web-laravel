...
class UserController extends Controller {
    ...
    public function edit($id, Request $request)
    {
        ...
        return makeResponse(200, 'success', null, $users);
    }
    ...
    public function getData()
    {
       ...
       return DataTables::of($result)
         ...
         ->addColumn('action', function($users) {
             ...
             $delete = '<a data-href="' . route('management.user.destroy', $users->id) . '" class="btn btn-icon btn-light btn-hover-danger btn-sm" "data-toggle="tooltip" data-placement="top" title="Delete" data-toggle="modal" data-target="#confirm-delete-modal">
