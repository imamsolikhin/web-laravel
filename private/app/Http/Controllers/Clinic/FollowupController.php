...
class FollowupController extends Controller {
    ...
    public static function save($request) {
        ...
        if ($validator->fails()) return redirect()->route('clinic.index','Followup')->with('notif_danger', 'New Followup '. $request->Name .' can not be save!');
        ...
        return redirect()->route('clinic.index','Followup')->with('notif_success', 'New Followup '. $request->Name .' has been added successfully!');
    }
