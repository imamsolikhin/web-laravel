...
class ClosingController extends Controller {
    ...
    public static function save($request) {
        ...
        if ($validator->fails()) return redirect()->route('clinic.index','Closing')->with('notif_danger', 'New Closing '. $request->FullName .' can not be save!');

        $closing = getControllerName("Clinic", "Closing")::execute($request);

        return redirect()->route('clinic.index','Closing')->with('notif_success', 'New Closing '. $request->FullName .' has been added successfully!');
    }
