...
use App\Http\Resources\Clinic\Customer;
...
class ClosingController extends Controller {
    ...
    public static function data($id) {
        $patient = Customer::withoutGlobalScopes(['active'])->findOrFail($id);
    ...
    public static function update($id, $request) {
        ...
        if ($validator->fails()) return redirect()->route('product.index','Closing')->with('notif_danger', 'Closing '. $data->FullName .' can not be closing!');
        ...
        return redirect()->route('product.index','Closing')->with('notif_success', 'Closing '. $data->FullName .' has been closing successfully!');
    }
    ...
    public static function list($request) {
        if($request->from_date != '' && $request->from_date  != ''){
          $result = Customer::withoutGlobalScopes()
        	...
        	$result = Customer::withoutGlobalScopes()->where("ReservationStatus","=","Closing");
        }
