...
class CompanyController extends Controller {
    ...
    {
        static::$module = 'Company';
        static::$module_alias = 'Company';
        static::$auth = 'company';
        static::$path = route('master.index','company');
        static::$data = route('master.list','company');
        static::$delete = route('master.delete',['company','']);
        static::$controller = getControllerName("Master", "Company");
        static::$resource = getResourceName("Master", "Company");
