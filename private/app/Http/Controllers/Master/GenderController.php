...
class GenderController extends Controller {
    ...
    {
        static::$module = 'Gender';
        static::$module_alias = 'Gender';
        static::$auth = 'gender';
        static::$path = route('master.index','gender');
        static::$data = route('master.list','gender');
        static::$delete = route('master.delete',['gender','']);
        static::$controller = getControllerName("Master", "Gender");
        static::$resource = getResourceName("Master", "Gender");
