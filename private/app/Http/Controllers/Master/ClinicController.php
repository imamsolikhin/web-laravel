...
class ClinicController extends Controller {
    ...
    {
        static::$module = 'Clinic';
        static::$module_alias = 'Clinic';
        static::$auth = 'clinic';
        static::$path = route('master.index','clinic');
        static::$data = route('master.list','clinic');
        static::$delete = route('master.delete',['clinic','']);
        static::$controller = getControllerName("Master", "Clinic");
        static::$resource = getResourceName("Master", "Clinic");
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Master","Clinic",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
