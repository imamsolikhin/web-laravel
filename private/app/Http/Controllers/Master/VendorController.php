...
class VendorController extends Controller{
    ...
    {
        static::$module = 'Vendor';
        static::$module_alias = 'Vendor';
        static::$auth = 'vendor';
        static::$path = route('master.index','vendor');
        static::$data = route('master.list','vendor');
        static::$delete = route('master.delete',['vendor','']);
        static::$controller = getControllerName("Master", "Vendor");
        static::$resource = getResourceName("Master", "Vendor");
