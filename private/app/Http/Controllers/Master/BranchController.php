...
class BranchController extends Controller {
    ...
    public static function init()
    {
        ...
        static::$module_alias = 'Branch';
        static::$auth = 'branch';
        static::$path = route('master.index','branch');
        static::$data = route('master.list','branch');
        static::$delete = route('master.delete',['branch','']);
        static::$controller = getControllerName("Master", "Branch");
        static::$resource = getResourceName("Master", "Branch");
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Master","Branch",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
