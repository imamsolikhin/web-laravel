...
class MarketController extends Controller {
    ...
    {
        static::$module = 'Market';
        static::$module_alias = 'Market';
        static::$auth = 'market';
        static::$path = route('master.index','market');
        static::$data = route('master.list','market');
        static::$delete = route('master.delete',['market','']);
        static::$controller = getControllerName("Master", "Market");
        static::$resource = getResourceName("Master", "Market");
