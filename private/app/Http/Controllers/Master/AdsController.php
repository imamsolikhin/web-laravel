...
class AdsController extends Controller {
    ...
    {
        static::$module = 'Advertise';
        static::$module_alias = 'Advertise';
        static::$auth = 'ads';
        static::$path = route('master.index','ads');
        static::$data = route('master.list','ads');
        static::$delete = route('master.delete',['ads','']);
        static::$controller = getControllerName("Master", "Ads");
        static::$resource = getResourceName("Master", "Ads");
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Master","Ads",sess_company('id'), "CTY", $numb=5);
        }
        if ($request->name){
