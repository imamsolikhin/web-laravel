...
class CourierController extends Controller {
    ...
    {
        static::$module = 'Courier';
        static::$module_alias = 'Courier';
        static::$auth = 'courier';
        static::$path = route('master.index','courier');
        static::$data = route('master.list','courier');
        static::$delete = route('master.delete',['courier','']);
        static::$controller = getControllerName("Master", "Courier");
        static::$resource = getResourceName("Master", "Courier");
