...
class CityController extends Controller {
    ...
    {
        static::$module = 'City';
        static::$module_alias = 'City';
        static::$auth = 'city';
        static::$path = route('master.index','city');
        static::$data = route('master.list','city');
        static::$delete = route('master.delete',['city','']);
        static::$controller = getControllerName("Master", "City");
        static::$resource = getResourceName("Master", "City");
    ...
    public static function list($request) {
     ...
     public static function execute($request, $data = null) {
        ...
        if ($request->id) {
            ...
            $data->id = generadeCode("Master","City",sess_company('id'),null, $numb=5);
        }
        if ($request->name){
