...
class ProductController extends Controller {
    ...
    public static function init()
    {
        ...
        static::$module_alias = 'Product';
        static::$auth = 'product';
        static::$path = route('master.index','product');
        static::$data = route('master.list','product');
        static::$delete = route('master.delete',['product','']);
        static::$controller = getControllerName("Master", "Product");
        static::$resource = getResourceName("Master", "Product");
