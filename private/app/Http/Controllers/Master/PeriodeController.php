...
class PeriodeController extends Controller {
    ...
    {
        static::$module = 'Periode';
        static::$module_alias = 'Periode';
        static::$auth = 'periode';
        static::$path = route('master.index','periode');
        static::$data = route('master.list','periode');
        static::$delete = route('master.delete',['periode','']);
        static::$controller = getControllerName("Master", "Periode");
        static::$resource = getResourceName("Master", "Periode");
