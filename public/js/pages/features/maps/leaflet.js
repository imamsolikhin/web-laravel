...
var KTLeaflet = function () {
  ...
  var demo1 = function demo1() {
    ...
    }).addTo(leaflet); // set custom SVG icon marker
    ...
    var marker = L.marker([-37.8179793, 144.9671293], {
      icon: leafletIcon
    }).addTo(leaflet);
  ...
  var demo2 = function demo2() {
    ...
    var marker = L.marker([51.5073219, -0.1276474], {
      icon: leafletIcon
    }).addTo(leaflet);
    marker.bindPopup("<b>City of London</b>").openPopup(); // set circle polygon
  ...
  var demo3 = function demo3() {
    ...
    var marker1 = L.marker([39.3262345, -4.8380649], {
      icon: leafletIcon1
    }).addTo(leaflet);
    var marker2 = L.marker([41.804, 13.843], {
      icon: leafletIcon2
    }).addTo(leaflet);
    var marker3 = L.marker([51.11, 10.371], {
      icon: leafletIcon3
    }).addTo(leaflet);
    var marker4 = L.marker([46.74, 2.417], {
      icon: leafletIcon4
    }).addTo(leaflet);
    marker1.bindPopup("Spain", {
      closeButton: false
    });
    marker2.bindPopup("Italy", {
      closeButton: false
    });
    marker3.bindPopup("Germany", {
      closeButton: false
    });
    marker4.bindPopup("France", {
      closeButton: false
    });
  ...
  var demo4 = function demo4() {
    ...
    var marker = L.marker([51.5, -0.09], {
      icon: leafletIcon
    }).addTo(leaflet); // set circle polygon
    ...
    var circle = L.circle([51.508, -0.11], {
      ...
      fillOpacity: 0.5,
      radius: 700
    }).addTo(leaflet); // set polygon

    var polygon = L.polygon([[51.509, -0.08], [51.503, -0.06], [51.51, -0.047]]).addTo(leaflet);
  };
  ...
  var demo5 = function demo5() {
    ...
    leaflet.on('click', function (e) {
      geocodeService.reverse().latlng(e.latlng).run(function (error, result) {
        ...
        alert("You've clicked on the following address: ".concat(result.address.Match_addr));
      });
    });
  };
  ...
  var demo6 = function demo6() {
    ...
    leaflet.addLayer(new L.TileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png')); // add scale layer

    L.control.scale().addTo(leaflet); // set custom SVG icon marker
