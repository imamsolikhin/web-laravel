...
var KTDatatablesBasicScrollable = function () {
  var initTable1 = function initTable1() {
    var table = $('#kt_datatable1'); // begin first table
  ...
  var initTable2 = function initTable2() {
    var table = $('#kt_datatable2'); // begin second table
    ...
    table.DataTable({
      ...
      createdRow: function createdRow(row, data, index) {
        ...
        badge = '<span class="label label-' + status[data[19]].state + ' label-dot mr-2"></span>' + '<span class="font-weight-bold text-' + status[data[19]].state + '">' + status[data[19]].title + '</span>';
